...
from .views import all_products, filter_brand, filter_price_range, store,product_detail, search, filter_category
app_name='store'
...
urlpatterns = [
    ...
    path('brand-filter/',filter_brand, name='brand-filter'),
